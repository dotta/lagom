...
/**
 * An exception that can be translated down to a specific error in the
 * transport.
 */
public class TransportException extends RuntimeException {
  ...
  public static TransportException fromCodeAndMessage(TransportErrorCode errorCode, ExceptionMessage exceptionMessage) {
    BiFunction<TransportErrorCode, ExceptionMessage, TransportException> creator = BY_NAME_TRANSPORT_EXCEPTIONS
