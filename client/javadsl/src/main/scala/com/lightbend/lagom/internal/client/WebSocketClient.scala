...
import com.lightbend.lagom.javadsl.api.deser.{ RawExceptionMessage, ExceptionSerializer }
        ...
        try {
          ...
          if (resp.getStatus.code >= 400 && resp.getStatus.code < 599) {
            ...
            try {
              ...
              val responseHeader = new InternalResponseHeader(resp.getStatus.code, responseProtocol, headers)
